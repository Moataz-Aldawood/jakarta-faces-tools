...
- **Component ID Autocomplete**: Typing inside `for="..."` or `target="..."` lists all available component `id="..."` declarations in the active file with clean right-aligned tag name descriptions (` : h:inputText`) and styled Markdown documentation cards.
